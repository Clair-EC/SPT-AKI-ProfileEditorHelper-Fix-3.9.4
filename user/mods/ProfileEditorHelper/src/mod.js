...
class Mod {
    ...
    postSptLoad(container) {
        ...
        // Traders still exporting on every run, due to nextResupply changes
    ...
    exportDictionaryEntry(name, dictionary) {
...
create a type script file that is similar to this which was for the non functioning code that was debuged: 
...
class Mod implements IPostSptLoadMod
{
	...
	public postSptLoad(container: DependencyContainer): void {
        ...
        this.logger.log([${this.modName}] : Started database exthis.logger.log([${this.modName}] : Started database exporting, "green");
